...
* **Лицензия:** MIT License (или укажите вашу)
...
void main() {
    // Вращение частиц вокруг оси Y
    vec3 rotated_pos = aPos;
    rotated_pos.xz = mat2(cos(rotation_angle), -sin(rotation_angle), sin(rotation_angle), cos(rotation_angle)) * rotated_pos.xz;
